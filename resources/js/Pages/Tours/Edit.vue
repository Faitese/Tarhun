...
const props = defineProps({ authr: Object, tour: Array, teams: Array })
...
const form = useForm({
    ...
    prize_pool: props.tour.prize_pool,
    teams: props.tour.teams,
    start_date: props.tour.start_date,
    end_date: props.tour.end_date,
    teams1: props.tour.teams1,
})
function store() {
    form.put(route('tour.update', props.tour.id))
}
